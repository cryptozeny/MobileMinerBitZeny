...
-(void)startMining{
    ...
    */
    char *args[]= {(char *)[execPath UTF8String],
      "-o",(char *)[[activeDict objectForKey:@"url"] UTF8String],
      "-u",(char *)[[activeDict objectForKey:@"user"] UTF8String],
      "-p",(char *)[[activeDict objectForKey:@"pass"] UTF8String],
      "-a","yescrypt",
      "-t",t,
      "-r","10",
      NULL
